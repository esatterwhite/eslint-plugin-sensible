...
module.exports = {
    meta: {
        ...
        docs: {
            description: "Better indentation for comma first style",
    ...
    create(context) {
        ...
        function report(token, neededIndent) {
            ...
            const neededChars = neededIndent * indentSize;

            context.report({
                node: token,
                messageId: "wrongIndentation",
                data: createErrorMessageData(neededChars, numSpaces, numTabs),
                loc: {
        ...
        function validateTokenIndent(token, desiredIndent) {
            ...
            return indentation === expectedChar.repeat(desiredIndent * indentSize) ||
